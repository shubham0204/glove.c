...
Java_com_shubham0204_projects_glove_GloVe_create(JNIEnv* env, jobject this_object, jstring embeddings_filepath,
                                                 jint vocab_size, jint embeddings_dim) {
    jboolean    is_copy;
...
Java_com_shubham0204_projects_glove_GloVe_annotate(JNIEnv* env, jobject this_object, jlong instance_addr,
                                                   jstring word) {
    jboolean    is_copy;
...
Java_com_shubham0204_projects_glove_GloVe_release(JNIEnv* env, jobject this_object, jlong instance_addr) {
    glove* instance = (glove*)instance_addr;
